...
function specPermittedTools(agentName) {
  const tables = {
    ...
    'foundry-admin': [
      ...
      'foundry_config_write_validator', 'foundry_config_write_test',
      'foundry_config_write_fixture', 'foundry_config_add_dependency',
      'foundry_config_git_log', 'foundry_config_run_validator',
      'foundry_config_run_validator_test', 'foundry_models_list',
