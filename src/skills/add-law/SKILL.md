...
After the validator implementation changes, update the companion test file. Run `foundry_config_run_validator_test` to confirm the tests pass against the updated validator before committing.
