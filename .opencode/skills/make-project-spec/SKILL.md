...
Check the current project structure, relevant docs, existing plans, and recent patterns before asking detailed questions. Follow existing conventions where they are clear.
...
- Existing systems or files affected
...
Use concrete, implementation-ready requirements. Avoid placeholders. Use British English spelling throughout prose, comments, and user-facing text.
...
- **Writing to docs/**: Project specs for this workflow live under `plans/<project-name>/SPEC.md`.
